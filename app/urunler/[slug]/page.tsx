...
export default async function ProductPage({ params }: Props) {
  ...
  const whatsappUrl = `https://wa.me/90XXXXXXXXXX?text=${whatsappMessage}`;
          ...
          <div className="flex flex-col gap-6 lg:sticky lg:top-8">
            ...
            <div>
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 w-full bg-green-500 hover:bg-green-600 text-white font-medium px-6 py-4 rounded-lg transition-colors text-base"
              >
